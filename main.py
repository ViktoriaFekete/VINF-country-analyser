...
def get_specific_data_from_article(_file):
    country_dict = {}
    ...
    languages_regex = '\| ?(languages|official_languages)\s*= ?(\{\{\w+\}\})*(\[|\]|\w+|,| |\||\.|\$|\n|\{|\*)+(\}\})?'
...
#
# def get_infobox_from_file(_file):
#     with open(_file, 'r', encoding='utf-8') as f:
#         lines = f.readlines()
#     f.closed
#
...
def main():
    wiki_file_240MB = 'C:/Users/vikto/Desktop/FIIT_ING/VINF/enwiki-latest-pages-articles1.xml-p1p41242'
